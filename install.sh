x='neovim neofetch xclip doublecmd-qt5  cmus redshift kitty kitty-terminfo plasma-browser-integration ranger xorg-xev xorg-xrandr docker docker-compose fasd manjaro-i3-settings
    andromeda-wallpaper plasma5-themes-andromeda sddm-andromeda-theme andromeda-icon-theme xdotool mariadb youtube-dl ncdu xcape graphviz valgrind
    ...
    fd clementine boost racket python-virtualenv ibus ibus-libpinyin ctags pacui mlocate'
